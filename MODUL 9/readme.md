...
## Dasar Teori
<p align="justify"> 
Pohon dan grafik adalah dua struktur data dasar dalam ilmu komputer. Pohon adalah struktur data hierarki yang terdiri dari node-node yang terhubung dimulai dari node khusus yang disebut root, sedangkan grafik adalah sekumpulan node yang dihubungkan oleh tepi. Dalam sebuah pohon, setiap simpul mempunyai tepat satu simpul induk, dan tidak boleh ada celah pada pohon tersebut. Graf dapat terdiri dari dua jenis, graf berarah dan graf tidak berarah, dan setiap simpul suatu graf dapat mempunyai hubungan dengan simpul lain melalui sisi-sisinya. Keduanya digunakan dalam berbagai aplikasi seperti representasi data hierarki, algoritma pencarian, jaringan komputer, dan pemetaan..
</p>
...
### Screenshot Output
![guided 1](https://github.com/Lorentz4kei/Struktur-Data-Assignment/assets/161665225/ce50fd2e-0d1f-4cf4-89ab-6ea97ddfcccd)
...
### Screenshot Output
![guided 2 1](https://github.com/Lorentz4kei/Struktur-Data-Assignment/assets/161665225/e9e9cefa-9ade-4334-9ee2-26627c2096dd)

![guided 2](https://github.com/Lorentz4kei/Struktur-Data-Assignment/assets/161665225/053782b2-2500-4460-894a-68b401e855f4)
...
```
### Screenshot Output
![unguided 1](https://github.com/Lorentz4kei/Struktur-Data-Assignment/assets/161665225/c9ac24ed-99cc-4250-b40f-7d4563c2a7e3)

### Deskripsi Program
Program ini merupakan aplikasi sederhana untuk membuat tabel koneksi antar node (kota) dalam suatu jaringan. Program ini meminta pengguna untuk memasukkan jumlah node (kota), nama node tersebut dan bobot koneksi antar node. Bobot tautan antar node dimasukkan sebagai matriks bobot yang berisi bobot dari node ke node itu sendiri, ke node lain, dan bobot balik dari node lain ke node ini. dari.
...
void buatNode_2311102193(char data) {
    if (isEmpty()) {
        root = newPohon(data);
        cout << "\nNode " << data << " berhasil dibuat menjadi root." << endl;
    } else {
...
### Screenshot Output
![unguided 2](https://github.com/Lorentz4kei/Struktur-Data-Assignment/assets/161665225/65d66bf3-6a94-45f8-9ffd-0db11a150054)


### Deskripsi Program
Program ini merupakan implementasi C++ dari struktur data pohon biner. Dalam program ini, pengguna dapat membuat, mengedit, dan menghapus node dalam pohon biner. Setiap node berisi data karakter dan dapat memiliki hingga dua anak (kiri dan kanan). Program ini menyediakan berbagai fungsi seperti membuat node baru, menambahkan node anak kiri atau kanan, memperbarui informasi tentang sebuah node, mencari informasi tentang node tertentu (seperti orang tua, saudara atau anaknya), melintasi pohon (preorder, inOrder , pascaPesanan). ), menghilangkan seluruh pohon atau hanya subpohon tertentu dan menghitung karakteristik pohon seperti ukuran dan tinggi.


## Kesimpulan 
<p align="justify">

Pohon dan grafik adalah dua struktur data yang penting dalam pemrograman dan representasi data. Pohon adalah struktur hierarki yang terdiri dari simpul-simpul yang terhubung secara progresif mulai dari simpul akar dengan anak-anak di bawahnya. Setiap node di pohon mempunyai anak, yang merupakan node lainnya. Sebaliknya, graf adalah himpunan simpul-simpul yang dihubungkan oleh sisi-sisinya. Grafik dapat digunakan untuk mewakili hubungan antara objek yang berbeda, seperti jaringan sosial, jaringan lalu lintas, atau jaringan komputer. Tree dan Graph memiliki beragam aplikasi untuk pemodelan data dan pemecahan masalah di berbagai bidang, termasuk pemrosesan bahasa alami, analisis jaringan, optimalisasi rute, dan banyak lagi.
</p>
